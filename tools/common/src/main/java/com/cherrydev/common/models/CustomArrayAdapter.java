...
public class CustomArrayAdapter<T> extends BaseAdapter implements Filterable, ThemedSpinnerAdapter {
     ...
     * @param objects            The objects to represent in the ListView.
     */
    public CustomArrayAdapter(@NonNull Context context, @LayoutRes int resource, @IdRes int textViewResourceId, @NonNull T[] objects) {
     ...
     * @param objects  The objects to represent in the ListView.
     */
    public CustomArrayAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<T> objects) {
    ...
    private CustomArrayAdapter(@NonNull Context context, @LayoutRes int resource, @IdRes int textViewResourceId, @NonNull List<T> objects, boolean objsFromResources) {
        mContext = context;
    ...
    CustomArrayAdapter<CharSequence> createFromResource(@NonNull Context context, @ArrayRes int textArrayResId, @LayoutRes int textViewResId) {
