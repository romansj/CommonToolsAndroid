...
public class MyItemAnimator extends SimpleItemAnimator {
    ...
    private long mAddDuration = Durations.MEDIUM;
    private long mRemoveDuration = Durations.SHORT;
    private long mMoveDuration = Durations.MEDIUM;
    private long mChangeDuration = Durations.MEDIUM;
    ...
    public boolean animateChange(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder,
        ...
        if (newHolder != null) {
            ...
            newHolder.itemView.setAlpha(0); //0
        }
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0).setListener(new AnimatorListenerAdapter() { //0
                @Override
                public void onAnimationStart(Animator animator) {
