...
public class ZeEdgeEffect extends EdgeEffect {

    /**
     * The default blend mode used by {@link ZeEdgeEffect}.
     */
    ...
    //(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123769450)
     ...
     */
    public ZeEdgeEffect(Context context) {
        super(context);
