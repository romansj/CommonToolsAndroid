...
object FluidContentResizer {
    ...
    fun listen(activity: Activity) {
        ...
        KeyboardVisibilityDetector.listen(viewHolder, object : VisibilityChangedInterface {
            override fun visibilityChanged(vis: KeyboardVisibilityChanged) {
                animateHeight(viewHolder, vis)
            }
